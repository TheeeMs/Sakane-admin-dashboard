...
export default function CreateReportModal({
  ...
  const validate = () => {
    ...
    if (mode === "create" && !residentId.trim())
      e.residentId = "Resident is required";
          ...
          {mode === "create" && (
            <div>
              ...
              <select
                ...
                style={{
                  ...inputStyle,
                  borderColor: errors.residentId ? "#ef4444" : "#e5e7eb",
                }}
              >
          ...
          <div>
            ...
            <textarea
              ...
              style={{
                ...
                resize: "none",
                lineHeight: 1.6,
                borderColor: errors.fullDesc ? "#ef4444" : "#e5e7eb",
              }}
            />
            {errors.fullDesc && (
              <p style={{ color: "#ef4444", fontSize: 12, margin: "4px 0 0" }}>
